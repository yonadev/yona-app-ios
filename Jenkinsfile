pipeline {
  ...
  stages {
    stage('Build and test') {
	  ...
	  sh 'xcrun xcodebuild -workspace Yona.xcworkspace -scheme Yona -sdk iphonesimulator -destination { platform:iOS Simulator, id:C49FB4A6-7209-4289-92C6-0AA8A8DA0122, OS:11.4, name:iPhone 8 Plus } -derivedDataPath ./BuildOutput test | xcpretty --report junit --output ./BuildOutput/Report/testreport.xml'
