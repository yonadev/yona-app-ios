...
//  ConsumerApp
//
//  Created by Dmytro Andreikiv on 15/01/16.
//  Copyright © 2016 Adriana Ormaetxea Arregi. All rights reserved.
//
...
public class ViewPositionKeyboardBehavior : Behavior {
    ...
    private func registerNotifications() {
        notificationCenter.addObserver(self,
            selector: #selector(ViewPositionKeyboardBehavior.keyboardWillChange(_:)),
            name: UIKeyboardWillChangeFrameNotification,
            object: nil)
        
        notificationCenter.addObserver(self,
            selector: #selector(ViewPositionKeyboardBehavior.keyboardWillHideNotification(_:)),
