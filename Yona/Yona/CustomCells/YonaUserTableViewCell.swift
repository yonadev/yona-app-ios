...
class YonaUserTableViewCell: PKSwipeTableViewCell {
    ...
    func addRightViewInCell() {
        ...
        btnCall.addTarget(self, action: #selector(self.deleteMessage(_:)), for: UIControl.Event.touchUpInside)
    ...
    func setMessage(_ aMessage : Message) {
        ...
        if aMessage.nickname.count > 0 && aMessage.userPhotoLink == nil && aMessage.messageType != notificationType.GoalConflictMessage {
