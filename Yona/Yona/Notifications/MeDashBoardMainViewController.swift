...
class MeDashBoardMainViewController: YonaTwoButtonsTableViewController {
    ...
    // MARK: - Scrollview delegate mathods
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if selectedTab == .left {
            ...
            if corretcToday.yearWeek == other {
                ...
                date = "\(rightTabData[section].date.shortDayMonthDateString()) - \(rightTabData[section].date.addingTimeInterval(6*60*60*24).shortDayMonthDateString())"
            }
        }
