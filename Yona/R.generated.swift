...
struct R {
  ...
  struct file {
    ...
    static var hockeySDKResourcesBundle: NSURL? { return _R.hostingBundle?.URLForResource("HockeySDKResources", withExtension: "bundle") }
    ...
    static var styleCss: NSURL? { return _R.hostingBundle?.URLForResource("style", withExtension: "css") }
  }
...
struct _R {
  static var hostingBundle: NSBundle? { return NSBundle(identifier: "com.xanton.yona") }
